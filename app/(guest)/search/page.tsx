import { Globe, Instagram, Phone, Star, Youtube } from "lucide-react";
    ...
    <div className="w-full justify-center pd-14 bg-[url(/img/bgrd.png)] bg-cover">
      ...
      <div className="w-[30%]">
        ...
        <p className="text-white">
          Temukan berbagai lokasi wisata di Bandar Lampung lengkap dengan rating,
          lokasi, jam buka, harga, dan ulasan di SiniGeh
        </p>
      </div>
      <div className="w-[20%]">
